          ...
          <div className="flex flex-wrap mb-4">
            {tabs.map((tab) => (
              ...
              >
                ...
                <span
                  className={`text-[#ea0fb4] text-[15px] text-center leading-[70px] ${monsterfont1.className} `}
                >
                  {tab.title}
                </span>
              </button>
          ...
          <div className="absolute bottom-0 left-0 w-full h-[3px] bg-white">
            ...
            <div
              ...
              style={{
                left: `${
                  (hoverTab
                    ? tabs.findIndex((t) => t.id === hoverTab)
                    : tabs.findIndex((t) => t.id === activeTab)) * 25
                }%`,
                width: "23%",
              }}
            ></div>
          ...
          {tabs.map((tab) => (
            ...
            >
              <div className="col-span-2">
                <h3
                  className={`text-[28px] ${monsterfont1.className}  font-bold mb-4 text-white`}
                >
                  {tab.subtitle}
                </h3>
                <div className="">
                  {tab.content.text.map((paragraph, index) => (
                    <p
                      key={index}
                      className="text-[15px] text-semi-white font-opensans mt-[40px]"
                    >
                      {paragraph}
                    </p>
                  ))}
