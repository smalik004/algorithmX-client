...
const DevelopmentProcess = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Discuss",
      description:
        "Your contributions are the most valuable assets for achieving success.",
      color: "bg-cyan-400",
    },
    {
      number: "03",
      title: "Make Plan",
      description:
        "A carefully crafted execution plan guarantees punctual delivery.",
      color: "bg-red-400",
    },
    {
      number: "04",
      title: "Production",
      description:
        '"Lights, camera, action!"—This is where all the magic unfolds.',
      color: "bg-orange-400",
    },
    {
      number: "05",
      ...
      description:
        "Where all elements are intricately woven together with creativity.",
      color: "bg-yellow-400",
    },
    {
      number: "06",
