  ...
  const services = [
    {
      ...
      description:
        "As experts who run TikTok ads in USA, we understand that viral success isn't about luck—we know the tactics that give you the best shot at real reach.",
    ...
    },
    {
      ...
      description:
        "Get insights in real-time. TikTok's analytics tools let you monitor performance down to the finest detail. Our TikTok ads agency ensures your campaigns stay optimized, tweaking them as we go to keep improving results.",
    ...
    },
    {
      ...
      description:
        "TikTok is perfect for creative storytelling. We help you craft a narrative that sticks, with ads that capture attention and leave a lasting impression.",
