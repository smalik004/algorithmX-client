      ...
      <div className="container max-w-[1200px] mx-auto ">
        <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-8">
          ...
          <div className="w-full md:w-1/2 text-white md:p-6">
            ...
            >
              Optimizing your LinkedIn profile boosts visibility and reach. Our
              LinkedIn Profile Management Services cover every detail—from
              crafting a polished bio to integrating keywords for searchability
              and creating LinkedIn summaries that highlight your expertise. We
              also curate LinkedIn highlights to feature your key achievements,
              ensuring your profile resonates with your audience and attracts
