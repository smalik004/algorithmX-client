...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: "stock", name: "Grammerly", image: "images/Grammerly.png" },
    {
      ...
      image: "images/Hemingway-Editor.png",
    },
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <p
          className={`text-semi-white text-center ${styles["toolbox-description"]}  ${monsterfont.className} mb-8 sm:mb-16 max-w-5xl mx-auto px-2`}
        >
          Versatile toolbox for creating compelling content across digital
          platforms and engaging diverse audiences effectively.
        </p>
        <div
