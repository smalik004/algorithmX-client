    ...
    iconSvg: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M4.5 20.25l15-15m0 0h-11.25m11.25 0V15"
        />
      </svg>
    ),
    color: "text-purple-500",
  ...
  return (
    <div className="min-h-screen bg-black p-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-white text-6xl font-light text-center mb-4">
          Industries
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-4">
          {industries.map((industry) => (
            ...
            >
              {/* Icon Container */}
              <div
                className={`absolute -left-1 z-10 ${styles["icon-custom-rounded"]}   p-4 bg-black ${industry.color} border-2 ${industry.borderColor} `}
              >
                <div className={industry.color}>{industry.iconSvg}</div>
              </div>

              {/* Main Container */}
              <div
                className={`w-full h-full ml-12 flex items-center  justify-center bg-black border-2 ${industry.borderColor} ${styles["custom-rounded"]}
