...
const FlipCard = ({ service }) => {
  return (
    <div className="relative h-[390px] w-[360px] ">
      {/* Mobile Layout */}
      <div className="md:hidden h-full">
        <div className="h-full bg-black  flex flex-col items-center justify-center">
          <div className="text-center">
            ...
            <p
              className={`text-white text-[14px] font-opensans .algo-line-height-21   mt-10 px-6`}
            >
              {service.description}
            </p>
            ...
            <div className="relative h-full">
              ...
              <div className="relative z-10  h-full px-7 ">
                <div className="text-center text-white">
                  ...
                  <p
                    className={`text-[16px] font-[Helvetica] .algo-line-height-21   mt-10`}
                  >
                    {service.description}
                  </p>
                </div>
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span
              ...
              } lg:text-8xl font-bold text-gray-600/20 transition-all duration-1000 transform
          ...
          <h2
            className={`font-size-40 .algo-line-height-48  ${monsterfont2.className} mt-6 md:mt-14 text-white`}
          >
            GRAPHICS
          </h2>
          <h2
            className={`font-size-40  ${monsterfont1.className} text-white -mt-2`}
          >
            SERVICES
          </h2>
        </div>
