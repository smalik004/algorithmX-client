  ...
  return (
    <div className="bg-black">
      <div className="flex items-center justify-center p-4 md:p-8 pt-20 md:mt-0">
        ...
        <div
          className={`w-full max-w-[800px] ${styles["responsive-hero"]} md:w-full  rounded-3xl border border-red-500 relative flex flex-col md:flex-row`}
        >
          {/* Left Section: Image Container (1/5 width) */}
          <div className="w-1/5 relative">
            {/* Image container */}
            <div
              className="absolute w-64 h-64 md:w-72 md:h-72 overflow-hidden border
                          left-[70%]  -top-32
          ...
          <div className="md:w-4/5 flex">
            ...
            <div className="md:w-4/5 flex flex-col items-center md:items-start  mt-40 md:mt-20  text-center md:text-left">
              <h2
                className={`${styles["hero-img-title"]} font-helveticaneue text-white `}
              >
                Experience AlgorithmX Today
              </h2>
              <p
                className={`text-semi-white ${styles["hero-img-description "]} font-helveticaneue mb-[20px] md:max-w-md`}
              >
                We're your full-stack solution for everything digital. Bring us
                your idea and we'll make it a success.
              </p>
