    ...
    <div className="min-h-screen bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1200px] mx-auto">
        <div className="bg-black rounded-3xl p-8 md:p-12 border border-zinc-800">
          <h2
            className={` text-[42px] leading-[1.3]  font-helveticaneue font-[700]  `}
          >
            Streamlining CRM Development
          </h2>
          <p
            className={`${style["dynamic-description1"]} font-helveticaneue font-[400] text-semi-white mb-20 `}
          >
            Our agile approach simplifies the CRM development process, ensuring
            a seamless integration that meets your specific needs. Experience
            efficiency, adaptability, and faster results, all while maintaining
            high quality and robust functionality.
          </p>
                  ...
                  {timelineSteps.slice(0, 4).map((step, index) => (
                    <div key={index} className="relative">
                      <div className="flex items-start gap-3">
                        ...
                        <h3
                          className={` ${styles["dynamic-subtitle"]} font-helveticaneue font-[700]  `}
                        >
                          {step.title}
                        </h3>
                      </div>
                      ...
                      <div
                        className={` ${styles["dynamic-description"]} leading-[24px] font-helveticaneue font-[400] mt-4 md:mt-8 `}
                      >
                        {step.description}
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4">
                  {timelineSteps.slice(4, 6).map((step, index) => (
                    <div key={index} className="relative">
                      ...
                      <div
                        className={`${styles["dynamic-description"]} font-helveticaneue font-[400] leading-[24px] mt-4 md:mt-8 `}
                      >
                        {step.description}
                      </div>
                    </div>
