      ...
      <div className="container max-w-[1200px] mx-auto ">
        <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-8">
          ...
          <div className="w-full md:w-1/2 text-white ">
            ...
            <p
              className={`${robotoFont1.className} text-semi-white text-[16px] line-[26px] `}
            >
              Looking to increase your Instagram followers? Our services include
              boosted posts that expand your reach and grow your audience
              through targeted ad spend. With precise audience targeting, you’ll
              effortlessly enjoy higher engagement rates and a growing follower
              base.
            </p>
          </div>
        </div>
