...
const SmoothScrollStack = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative " ref={containerRef}>
      <h1
        className={`text-[56px]  md:leading-[40px] md:leading-[50px] text-white md:tracking-[0.06em] ${monsterfont.className} text-center py- z-10 `}
      >
        OUR SOLUTIONS
      </h1>
