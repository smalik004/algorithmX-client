  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          Advanced tools for enhancing social media engagement, audience growth,
          and brand presence.
        </p>
        <div
          className={`container justify-center justify-items-center pl-8 md:pl-0 ${styles["margin1"]}`}
        >
