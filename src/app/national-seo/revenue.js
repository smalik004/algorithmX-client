...
const NationalRevenueSection = () => {
  ...
  const content = {
    "scale-strategy": {
      ...
      description:
        'We focus on keywords that signal strong purchase intent—terms like "buy," "pricing," and specific product searches. This approach helps attract visitors who are ready to convert, driving more sales.',
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "high-converting": {
      ...
      description:
        "We optimize your most important pages with detailed descriptions, unique selling points, and strong CTAs. This ensures they rank higher and convert more visitors into paying customers.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "sync-strategy": {
      ...
      description:
        "Our team continuously improves your website's conversion funnel. By analyzing user behavior and running A/B tests, we ensure your site turns visitors into customers.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
