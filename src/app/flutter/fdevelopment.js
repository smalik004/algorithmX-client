...
const MigrationDescriptionWithLink = () => (
  <>
    At AlgorithmX, we have expertise in transferring your Android and iOS apps
    to Flutter. With our expert Flutter Android app development team, we are
    skilled at moving your current apps across different platforms and operating
    systems. As a premier{" "}
    <Link href="/app-development" className="text-blue-300 hover:text-blue-400">
      app development company in USA
    </Link>
    , we guarantee the development of applications that cater to your
    requirements.
  </>
);
