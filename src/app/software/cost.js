  ...
  const estimates = [
    ...
    },
    {
      ...
      icon: (
        <FontAwesomeIcon
          icon={faCut}
          className="text-[#2775ff] w-[43.72px] h-[52px] "
        />
    ...
    },
    {
      ...
      icon: (
        <FontAwesomeIcon
          icon={faShoppingCart}
          className="text-[#2775ff]  w-[56.25px] h-[52px] "
        />
      ), // Fixed FontAwesome icon
    ...
    },
    {
      ...
      description:
        "Creating a moderately complex specialized automation solution tailored to specific needs (such as accounting, supply chain management, or ecommerce)",
    },
    {
      iconType: "fa",
      icon: (
      ...
      description:
        "Deploying an extensive business automation system fueled by big data and artificial intelligence/machine learning capabilities",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black p-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <h2
          className={`${style["cost-title"]} ${monsterfont1.className} text-white mb-8`}
        >
          Estimations
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {estimates.slice(0, 3).map((item, index) => (
            ...
            >
              ...
              <div
                className={`${styles["cost-price"]} ${monsterfont2.className} text-white text-center`}
              >
                {item.price}
              </div>
              <p
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          {estimates.slice(3).map((item, index) => (
            <div
              key={index + 3}
              className={`p-6 ${style["border-design1"]} bg-black flex flex-col items-center text-center mr-[10px] ml-[10px]`}
            >
              <div className="mb-4 mt-[30px]">
                {item.icon} {/* Render FontAwesome icon */}
              </div>
