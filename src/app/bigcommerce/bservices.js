...
const BigcommerceServices = () => {
  const services = [
    ...
    },
    {
      ...
      description: (
        <>
          Being a top BigCommerce{" "}
          <Link href="/web-development" className="hover:text-blue-400">
            web development agency
          </Link>
          , our migration solutions focus on making the transition smooth and
          efficient while minimizing disruptions and maximizing improvements.
          Our team is expert in handling tasks such as data migration, product
          transfer, SEO preservation, and customization.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          ...
          , we provide constant support to ensure the reliability, security, and
          outstanding performance of BigCommerce solutions with a main focus on
          consistent monitoring and frequent updates, thus enhancing user
          satisfaction.
        </>
      ),
    ...
    },
    {
      ...
      description:
        "With AlgorithmX's dynamic mobile apps, your shopping encounters become more fascinating, transcending simple transactions. Our BigCommerce app development services guarantee swift interactions from browsing to checkout on any device.",
      borderColor: "border-blue-500",
