          ...
          <div className="w-full md:w-1/2 text-white order-2 md:order-1 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            >
              <span className="text-[#DC3545]">
                Ride the TikTok Wave with Creative Content
              </span>{" "}
              TikTok is a powerhouse of creative content like no other. From
              conception to distribution, the content needs to be strategized to
              captivate the audience. to craft a content calendar brimming with
              fresh ideas, trending challenges, and stories that resonate with
              your target audience. We will also help you connect with the
              perfect influencers who seamlessly align wi
            </p>
          </div>
