...
const carouselData = [
  {
    ...
    title: "Content Ideas",
    description:
      "We’re always on top of the latest TikTok trends and will provide ideas that keep your brand in the mix. All you have to do is film! We take your raw footage and turn it into polished, high-engagement TikTok videos, making sure every detail works to get attention.",
  },
  {
    id: "custom-erp",
    ...
    title: "Video Editing",
    description:
      "You provide us with the video content you would like to use, and we will edit them to perform best on TikTok! We will use our top-notch video editing software to optimize your TikTok content!",
  },
  {
    id: "monitoring",
    ...
    title: "Monitoring",
    description:
      "We manage the day-to-day, keeping up with comments, duets, and messages, so your audience feels seen and heard.",
  },
  {
    id: "erp-development",
    ...
    description:
      "Our experienced TikTok manager will keep you updated with easy-to-understand reports that show your progress—everything from growth rates to who’s watching your videos and how long they’re sticking around.",
  },
  {
    id: "custom-erp1",
    icon: "/images/video-editing.png",
...
const TiktokCarousel = () => {
  ...
  return (
    <div className="w-full mx-auto px-4 py-8 bg-black relative">
      <h1
        className={`${styles["erp-text"]} text-white ${monsterfont.className} mb-12`}
      >
        How It Works
      </h1>
      <div
      ...
      >
        {visibleItems.map((item, index) => {
          ...
          return (
            ...
            >
              <div
                className={`bg-black bg-opacity-50 p-6 md:p-14 ${styles["box-border"]} w-full h-auto`}
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  />
                  <h3
                    className={`${styles["erp-title"]} ${monsterfont.className} text-white text-center mt-6`}
                  >
