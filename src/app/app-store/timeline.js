  ...
  return (
    <div className="min-h-screen bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          <h1
            className={`text-[32px]  leading-[37px] md:text-[42px] md:leading-[45px] font-helveticaneue font-[700] leading-[1.3] mb-[5px]  `}
          >
          ...
          <p className="text-[15px] font-helveticaneue leading-[20px] text-semi-white mb-[40px] ">
            We approach App Store Optimization (ASO) through meticulous keyword
            research, strategic content optimization, continuous performance
            monitoring, iterative improvements, and tailored localization
                  ...
                  {timelineSteps.slice(0, 4).map((step, index) => (
                    <div key={index} className="relative">
                      <div className="flex items-start gap-3">
                        ...
                        <h3
                          className={` text-[18px] leading-[1.3] font-[700] font-helveticaneue  `}
                        >
                          {step.title}
                        </h3>
                      </div>
                      ...
                      <div
                        className={` text-[12px] leading-[24px]  font-helveticaneue mt-4 md:mt-8 px-[20px]`}
                      >
                        {step.description}
                      </div>
                    </div>
