...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: "figma", name: "ASOdesk", image: "/images/ASOdesk.png" },
    {
      ...
      image: "/images/Firebase-Analytics.png",
    },
    {
      id: "stock",
      name: "Google Play",
      image: "/images/Google-Play-Experiments.png",
    },
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          The technology stack for ASO improves app visibility through keyword
          research, analytics, metadata optimization, A/B testing, and SEO
          tools.
        </p>
        <div
