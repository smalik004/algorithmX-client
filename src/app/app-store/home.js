    ...
    <div className="min-h-screen bg-black pt-[100px]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 ">
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          >
            Comprehensive app store optimization services of AlgorithmX drive
            downloads and enhance your app’s visibility to reach the desired
            audience and gain top rankings.
          </p>
        </div>
      </div>
    </div>
