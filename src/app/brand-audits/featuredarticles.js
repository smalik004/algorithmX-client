  ...
  return (
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        ...
        <meta
          name="description"
          content="Featured outdoor adventure articles"
        />
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <Link
              href="/ads-audit"
              className="block relative h-72 md:h-80 rounded-lg overflow-hidden shadow-lg group"
            >
            ...
            {/* Second Article Card */}
            <Link
              href="/articles/sun-sand-and-serenity-beach-bliss"
              className="block relative h-72 md:h-80 rounded-lg overflow-hidden shadow-lg group"
            >
              <div className="absolute inset-0 w-full h-full transition-transform duration-500 group-hover:scale-110">
                <Image
          ...
          <Link
            href="/articles/why-its-worth-hiking-the-john-muir-trail"
            className="block relative h-[20rem] md:h-[41.4rem] rounded-lg overflow-hidden shadow-lg group"
          >
            <div className="absolute inset-0 w-full h-full transition-transform duration-500 group-hover:scale-110">
              <Image
                fill
