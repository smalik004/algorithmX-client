...
const ConsultingPartner = () => {
  ...
  const content = {
    "scale-strategy": {
      ...
      description:
        "Your potential customers are ready to invest, but without the right visibility, they may never find your store.Our eCommerce SEO services ensure your store stands out, driving traffic and maximizing profits. As an eCommerce SEO agency,we specialize in connecting you with shoppers who are ready to buy.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "high-converting": {
      ...
      description:
        "Next, our SEO team conducts a comprehensive audit, covering on-page, off-page, and technical SEO aspects. This detailed analysis allows us to identify opportunities for improvement and lay the groundwork for your strategy.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "sync-strategy": {
      ...
      description:
        "Using insights from the audit and your specific goals, your account manager will provide actionable recommendations. You have the option to implement these steps with our team or handle them in-house.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
...
v-14.91H29.26V28.694z M30.638,13.949H17.687V8.515h11.397c0.858,0,1.554,0.698,1.554,1.555V13.949z"
    ...
    "performance-strategy": {
      ...
      description:
        "Our goal is continual growth. We monitor results and refine strategies to make steady improvements, ensuring you see a measurable impact on traffic, rankings, and revenue.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
