      ...
      <div className="container max-w-[1200px] mx-auto ">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-2">
            ...
            >
              Effective SEO goes beyond keywords and rankings. Our certified SEO
              consultants work closely with you to build a strategy that conveys
              your brand’s unique narrative, connecting with your audience in
              meaningful ways.
            </p>
          </div>
        </div>
