  ...
  const tabs = [
      ...
      content: {
        ...
        text: (
          <>
            ...
            pinpoints areas for improvement, enabling impactful changes across
            your site. This comprehensive analysis covers:
          </>
        ),
        items: [
          "Industry dynamics",
...

    {
      ...
      content: {
        ...
        text: "Gain an edge with insights into your competitors' strategies. Our in-depth competitor analysis reveals:",
        items: [
          "SEO strategies they employ",
          "Rabking positions",
...

    {
      ...
      content: {
        ...
        text: "Improve your site's critical metrics and user experience through our usability analysis. We evaluate:",
...

    {
      ...
      icon: faCodepen,
      content: {
        title: "360° SEO optimizations",
        text: "Our organic SEO consulting services in USA combine technical insight with strategic planning. Our technical SEO consultants offer a full suite of services to cover every SEO need:",
        items: [
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <h2
          className={`text-[64px] leading-[68px] ${monsterfont2.className} text-white mb-[15px] text-center`}
        >
          Expert SEO Services
        </h2>
        <h2
          className={`text-[64px] leading-[68px] ${monsterfont1.className} text-white mb-[15px] text-center`}
        >
          that Drive Results
        </h2>
          ...
          {tabs.map((tab) => (
            ...
            >
              <div className="text-center max-w-4xl mx-auto px-4">
                ...
                <p
                  className={`text-[16px] leading-[22px] font-helveticaneue mb-[2px] max-w-3xl mx-auto`}
                >
                  {tab.content.text}
                </p>
