  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 pt-[100px] md:pt-[100px]">
      <div className="max-w-6xl mx-auto relative">
        ...
        <h1
          className={`text-[36px] leading-[40px] mb-[30px] ${monsterfont.className}`}
        >
          Get in Touch!
        </h1>
        <div
          className={`text-[48px] leading-[52px] mb-[50px] ${monsterfont1.className}`}
        >
          <h2>Have an idea?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-10">
          <div className="space-y-6">
            <h3
              className={`text-[24px] leading-[28px] mb-[10px] ${monsterfont1.className}`}
            >
              Send a Request
            </h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <option value="App Development" className="bg-black text-white">
                  App Development
                </option>
                <option value="IoT Development" className="bg-black text-white">
                  IoT Development
                </option>
          ...
          <div className="bg-black px-10 py-[80px] contact-card">
            <h3
              className={`text-[24px] leading-[28px] mb-[60px] ${monsterfont1.className}`}
            >
              Find Us
            </h3>
            <div className="">
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  className={`text-[14px] leading-[18px] font-[Helvetica] font-[700] mb-3 hover:underline`}
                >
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="tel:+14255776660"
                  className={`text-[14px] leading-[18px] font-[Helvetica] font-[500] hover:underline`}
                >
                  +1-425-577-6660
                </a>
              </div>
