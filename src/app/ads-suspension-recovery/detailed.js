        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-8">
          ...
          <div className="w-full md:w-1/2 flex justify-center ">
            <div className="transform md:-rotate-12 ">
              <div className="relative w-[320px] h-[330px] md:w-[400px] md:h-[400px] overflow-hidden border-4 border-white">
                <Image
          ...
          <div className="w-full md:w-1/2 text-white md:p-6">
            ...
            >
              The keywords powering your campaign can also be your undoing.
              Google changes its policies towards how you advertise to fall in
              line with new advertising guidelines. We analyze the keywords for
              all of your campaigns to make sure you're not targeting anything
