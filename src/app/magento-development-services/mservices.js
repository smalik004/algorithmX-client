...
const SecurityDescriptionWithLink = () => (
  <>
    In{" "}
    <Link href="/cms" className="text-blue-300 hover:text-blue-400">
      ecommerce website development
    </Link>
    , AlgorithmX prioritizes the significance of security, so we apply safety
    measures like timely security audits, SSL certificates, and secure payment
    gateways to avoid breach of security and protect clients' data.
  </>
);

const IntegrationDescriptionWithLink = () => (
  <>
    As numerous businesses depend on third-party systems like{" "}
    <Link href="/crm" className="text-blue-300 hover:text-blue-400">
      CRM
    </Link>
    , inventory management software and{" "}
    <Link href="/erp" className="text-blue-300 hover:text-blue-400">
      ERP
    </Link>
    , our certified Magento developer integrates Magento with these systems.
    This helps synchronize datasets, streamline operations and enhance
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3
                  className={`${styles["development-title"]} font-helveticaneue mb-3 text-white`}
                >
                  {service.title}
                </h3>
                <p
