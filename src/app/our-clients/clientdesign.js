...
const gridItems = [
  ...
  {
    title: "Audible Purchase UX",
    bgColor: "bg-gradient-to-br from-green-400 to-orange-500",
    hoverContent: "How small UI delighters have a huge impact on UX",
    timeRead: "5 min",
    logoImage: "/images/mac.webp",
    characterImage: "/images/mac1.webp",
  ...
  {
    title: "Audible Purchase UX",
    bgColor: "bg-gradient-to-br from-pink-400 to-orange-500",
    hoverContent: "How small UI delighters have a huge impact on UX",
    timeRead: "5 min",
    logoImage: "/images/mac.webp",
    characterImage: "/images/mac1.webp",
  ...
  {
    title: "Audible Purchase UX",
    bgColor: "bg-gradient-to-br from-purple-400 to-orange-500",
    hoverContent: "How small UI delighters have a huge impact on UX",
    timeRead: "5 min",
    logoImage: "/images/mac.webp",
    characterImage: "/images/mac1.webp",
  ...
  {
    title: "Audible Purchase UX",
    bgColor: "bg-gradient-to-br from-green-400 to-red-500",
    hoverContent: "How small UI delighters have a huge impact on UX",
    timeRead: "5 min",
    logoImage: "/images/mac.webp",
    characterImage: "/images/mac1.webp",
  ...
  {
    title: "Audible Purchase UX",
    bgColor: "bg-gradient-to-br from-blue-400 to-red-500",
    hoverContent: "How small UI delighters have a huge impact on UX",
    timeRead: "5 min",
    logoImage: "/images/mac.webp",
    characterImage: "/images/mac1.webp",
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
          {filteredItems.map((item, index) => (
            <Link key={index} href={item.link} className="block">
              ...
              >
                <div
                  className={`absolute inset-0 rounded-xl text-white ${
                    item.bgColor
                  ...
                  >
                    ...
                    <div className="w-20 h-20 md:w-28 md:h-28 mb-3 md:mb-6 flex items-center justify-center relative">
                      ...
                      <Image
                        ...
                        style={{
                          transform:
                            hoveredIndex === index ? "scale(1)" : "scale(0.5)",
