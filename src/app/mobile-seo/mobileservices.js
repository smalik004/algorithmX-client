...
const MobileServices = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      icon: faGem,
      content: {
        title: "Lightning-Fast Mobile Page Speed Optimization",
    ...
    },
    {
      ...
      icon: faGg,
      content: {
        title: "Mobile-Friendly Content Optimization",
    ...
    },
    {
      ...
      icon: faCodepen,
      content: {
        title: "Mobile-Specific Keyword Optimization",
    ...
    },
    {
      ...
      icon: faCodepen,
      content: {
        title: "Comprehensive Mobile SEO Audits",
