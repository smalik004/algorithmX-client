...
const MobileRevenueSection = () => {
  ...
  const content = {
    "scale-strategy": {
      ...
      description:
        "As a leading mobile SEO company, we prioritize speed and responsiveness. Mobile shoppers expect fast load times, straightforward navigation, and engaging CTAs. Our mobile SEO services optimize every page to meet these demands, driving a seamless experience that converts on any device",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "high-converting": {
      ...
      description:
        "Mobile users search differently. We find and target the specific mobile keywords that match how people search on their phones, from local “near me” queries to high-intent keywords. The result? You’re ranking for the terms that bring ready-to-buy customers straight to your site.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "sync-strategy": {
      ...
      description:
        "Mobile conversions require a different approach than desktop. Our CRO experts analyze user behavior on your mobile site, using data-driven insights to refine the customer journey. We perform A/B testing and optimize CTAs to ensure that every visitor turns into a paying customer.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
              ...
              <div className="h-full overflow-y-auto pr-4">
                <div key={activeTab} className={contentClasses}>
                  <div className="transition-all duration-500 transform">
                    <h3
                      className={`text-[34px] leading-[42px] font-helveticaneue font-[300] mb-5`}
                    >
                      {content[activeTab].boxTitle}
                    </h3>
                    <div
