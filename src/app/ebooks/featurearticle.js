...
export default function Featuredarticle1() {
  return (
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:[&>*:first-child]:order-2">
          ...
          <div className="flex flex-col space-y-6">
            ...
            {/* Second Article Card */}
            <Link href="/dApp" className="block relative h-72 md:h-80 rounded-lg overflow-hidden shadow-lg group">
              <div className="absolute inset-0 w-full h-full transition-transform duration-500 group-hover:scale-110">
                <Image 
                  src="/images/explore-image-8.jpg"
          ...
          <Link href="/erp" className="block relative h-[40rem] md:h-[41rem] rounded-lg overflow-hidden shadow-lg group">
            <div className="absolute inset-0 w-full h-full transition-transform duration-500 group-hover:scale-110">
            <Image 
