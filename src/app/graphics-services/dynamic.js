  ...
  const steps = [
    {
      ...
      title: "Briefing",
      description:
        "Given that AlgorithmX is a premier graphic design company in USA that emphasizes process-oriented work, clear communication appeals to us. Initially, we review all project details, including your requirements sent via email, message, or call. Our team of graphic designers engages in conversation to understand and meet your needs providing budget quotes and timelines to align with your expectations.",
    },
    {
      number: 2,
      title: "Wireframing",
      description:
        "In this planning stage of our graphic design services, we present customized wireframes to suit your requirements. These wireframes act as a roadmap assisting us in deciding the layout, strategy, and aesthetic of the design.",
    },
    {
      number: 3,
      title: "Designing",
      description:
        "After our team at AlgorithmX gets all the specifications and finalizes the wireframe, our graphic designers in USA begin design work. Further requirements, suggestions, or last-minute changes are discussed to ensure smooth collaboration leading to the handover from the designers to the project managers offering best web design services for small businesses.",
    },
    {
      number: 4,
      title: "Delivery",
      description:
        "It's time, the delivery is finally arriving! In this phase, we unveil the design draft for your review and input. As part of our amazing graphic design services, we follow a unique cyclic approach to handle your revision requests. Once we are done finalizing everything, we share the completed file with you.",
    },
  ];
