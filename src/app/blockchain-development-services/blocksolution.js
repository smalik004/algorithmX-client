  ...
  return (
    <div className="min-h-screen bg-black text-white py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h2
          className={`${styles["solution-title"]} ${monsterfont.className} text-center`}
        >
          BLOCKCHAIN SOLUTIONS
        </h2>
        <h2
          className={`${styles["solution-title"]} ${monsterfont2.className} text-center mb-8`}
        >
          WE DELIVER
        </h2>
        ...
        <p
          className={`${styles["solution-subtitle"]} ${monsterfont1.className} text-center mb-16 text-semi-white`}
        >
          As a leading blockchain application development company, AlgorithmX
          provides personalized solutions designed to suit your business
          requirements. Employing an agile methodology, we prioritize
          comprehending your distinct needs, enabling us to devise bespoke
          blockchain solutions that foster innovation in your business
          processes.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-[3.5rem] max-w-4xl content-center mx-auto">
          {solutions.map((solution) => (
            <div key={solution.id} className="flex items-center space-x-3">
              ...
              <span
                className={`${styles["solution-description"]} font-helveticaneue `}
              >
                {solution.title}
              </span>
            </div>
