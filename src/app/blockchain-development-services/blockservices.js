...
const crmServices = [
  {
    ...
    content:
      "AlgorithmX is a premier blockchain development company that provides tailor-made blockchain application development and ",
    content2: (
    ...
    content3:
      ". We offer expert blockchain consultation services to assist in launching productive blockchain solutions. Our talented blockchain software developers build reliable and secure solutions to grow your business forward, whether starting from scratch or optimizing existing systems.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content:
      "AlgorithmX's blockchain development services involve creating cryptocurrency applications that help your business set up a transparent and decentralized financial system. Our team of cryptocurrency experts with a wealth of experience holds the necessary instruments essential for developing a highly functional trading platform where users can easily sell, purchase or exchange cryptocurrencies.",
  },
  {
    id: 8,
    ...
    content:
      "As a well-known blockchain development company, we provide end-to-end solutions for IEO and ICO development, and our blockchain and crypto developers help you create a high-quality initial exchange offering platform designed to attract funding for your cryptocurrency project.",
  },
  {
    id: 9,
...
const CRMServices = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      ...
      >
        BLOCKCHAIN <br /> DEVELOPMENT <br />{" "}
        <span className={`${monsterfont1.className}`}>Services</span>
      </h2>
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row">
              ...
              >
                ...
                >
                  ...
                  >
                    {service.title}
                    <span
                      className={`ml-1 transition-colors mb-[4px] duration-300 w-[6.4px] ${
        ...
        >
          <div
            className={`md:pt-6 pt-2 pr-2 pl-2 md:pr-10 md:pl-10 ${styles["box-border1"]} rounded w-full h-[420px] md:h-[300px]`}
          >
            ...
            >
              {isMobile ? (
                <>
                  ...
                  {activeService.content2}
                  {activeService.content3}
                </>
              ) : (
                <>
                  {hoveredService.content}
                  {hoveredService.content2}
                  {hoveredService.content3}
                </>
              )}
            </p>
          </div>
