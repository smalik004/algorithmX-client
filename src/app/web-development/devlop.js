      ...
      <div className="max-w-[1150px] mx-auto mt-10">
        <div className="text-center mb-16 relative overflow-hidden">
          <div className="relative z-10">
            <h2
              className={` text-[56px] leading-[60px] tracking-[0.06em] ${monsterfont2.className} mt-[20px] text-white `}
            >
              WEB DESIGN & DEVELOPMENT
            </h2>
            <h2
              className={`text-[56px] leading-[60px] tracking-[0.06em] ${monsterfont1.className}  text-white `}
            >
              PROCESS
            </h2>
            <div className="mx-auto w-[35px] h-[2px] bg-[#2775ff] mt-5"></div>
            <h2
              className={` text-[16px] leading-[1.1] ${monsterfont1.className} mt-5 text-semi-white tracking-[0.06em]`}
            >
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative flex-1">
              ...
              <div className="p-4 mt-2 md:mt-0">
                ...
                <p
                  className={`text-white ${styles["craft-description"]} ml-[30px]`}
                >
                  {step.description}
                </p>
              </div>
