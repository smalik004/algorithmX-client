...
const steps = [
    ...
    description: 'Our experienced website developers upgrade projects by performing competitive analysis and efficiently organizing tasks.',
    color: 'bg-green-400',
    },
    {
    number: '02',
    title: 'Wireframing & Prototyping',
    description: 'Our web development company designs monochrome wireframes and initial prototypes to depict user navigation through the system.',
    color: 'bg-cyan-400',
    },
    {
    number: '03',
    ...
    description: 'Then, we delve into application development and code review at our offshore web development company.',
    color: 'bg-orange-400',
    },
    {
    number: '05',
    title: 'Testing & Bug-fixing',
    description: 'Before launching, we conduct rigorous manual and automated testing to detect and fix as many bugs as we can in our web design & development services',
    color: 'bg-yellow-400',
    },
    {
    number: '06',
