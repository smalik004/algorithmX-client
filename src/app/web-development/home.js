    ...
    <div className="min-h-screen bg-black pt-[100px]">
      <div className="max-w-[1200px] mx-auto px-4 md:px-2 py-10">
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          >
            AlgorithmX offers outstanding web development services where we
            utilize the latest technologies and creativity to develop custom
            digital experiences, from an ecommerce platform and a sleek
            corporate site to a powerful web application. We craft innovative
