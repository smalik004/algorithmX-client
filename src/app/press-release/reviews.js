    ...
    Phone: {
      ...
      featuredVideos: [
        ...
        },
        {
          id: 2,
          title:
            "A social network isn't built for us until the space and its technologies are diverse",
          image: "/images/post-md-01.jpg",
        ...
        {currentContent.featuredReviews.map((review) => (
          ...
          >
            ...
            <div className="relative overflow-hidden h-64">
              {" "}
              {/* Fixed height for equal sized images */}
            ...
            <div className="space-y-4">
              {currentContent.featuredVideos.map((video) => (
                <Link key={video.id} href={video.url} className="block group">
                  ...
                  <h4 className="text-sm font-medium group-hover:underline text-black">
                    {video.title}
                  </h4>
                </Link>
              ))}
