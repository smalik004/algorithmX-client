...
const SmoothScrollStack = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "Stay connected to your audience. Use advanced tools to monitor brand mentions and sentiment, keeping you in tune with what your audience is saying. We:",
      color: "#000000", // Black background for the box
      url: "#",
    ...
    },
    {
      ...
      description:
        "Facebook marketing needs to be aligned with your business goals, whether you’re looking to drive website traffic, generate leads, or increase customer satisfaction. Our Facebook marketing strategists develop benchmark reports and track key metrics every month, including:",
      color: "#000000", // Black background for the box
      url: "#",
  ...
  return (
    <div className="min-h-screen bg-black relative" ref={containerRef}>
      <h1
        className={`text-[56px] text-white md:leading-[40px] md:leading-[50px] md:tracking-[0.06em] ${monsterfont.className} text-center py-4 z-10`}
      >
        BOOST YOUR BRAND
      </h1>
...
const Card = ({
  ...
  return (
    <div
      ref={cardRef}
      className="h-screen sticky top-0 flex items-center justify-center px-4 md:px-8"
    >
      <motion.div
        style={{
      ...
      >
        <div className="flex flex-col md:flex-row flex-1 gap-4 md:gap-8">
          <div className="flex-1 flex flex-col">
            <h2
              className={`text-[36px] leading-[1.1] mb-4 text-left text-white   font-helveticaneue font-[400] `}
            >
              {title}
            </h2>
            <p className="text-[15px] font-helveticaneue leading-[20px] text-semi-white whitespace-pre-wrap">
              {description}
            </p>
            ...
            {title === "Reporting for Your Social Media Campaign" && (
              <p className="mt-4 text-sm text-gray-400">
                We create custom reports for special initiatives like contests
                and user-generated content campaigns. These reports are
                continuously refined to improve your strategy, helping you get
                better results and higher ROI from your Facebook efforts. Plus,
                the insights we gather from Facebook fuel growth across other
                digital marketing channels, ensuring a cohesive, data-driven
