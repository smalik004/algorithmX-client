      ...
      <div className="container max-w-[1200px] mx-auto p-4">
        <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-8">
          ...
          <div className="w-full md:w-1/2 text-white order-2 md:order-1  ">
            ...
            <p
              className={`text-[#d93]  text-[1.35rem] leading-[1] font-[400] ${robotoFont2.className}`}
            >
              Stay Relevant in a Fast-Moving Platform
            </p>

            <p
              className={`text-semi-white text-[16px] leading-[26px]  ${robotoFont.className}`}
            >
              Success on Twitter requires more than just posting content. Stay
              up-to-date, engaging with followers, prompt reactions, and most
              importantly, high-quality content is the recipe to Twitter's
              success. Real-time monitoring and engagement, allowing you to
              focus on your business while we handle interactions
            </p>
          </div>
