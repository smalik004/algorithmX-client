      ...
      >
        <div className="flex flex-col md:flex-row flex-1 gap-4 md:gap-8">
          <div className="flex-1 flex flex-col">
            ...
            <p className="text-[15px] font-[Helvetica] leading-[20px] text-semi-white whitespace-pre-wrap">
              {description}
            </p>
