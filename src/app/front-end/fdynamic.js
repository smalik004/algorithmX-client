    ...
    <div className="min-h-screen h-full bg-black text-gray-300 p-8 ">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2
            className={` ${styles["dynamic-title"]} ${monsterfont1.className} text-white mb-2`}
          >
            Implementation
          </h2>
          <h2
            className={` ${styles["dynamic-title"]} ${monsterfont.className} text-white`}
          >
            Process
          </h2>
        </div>
        ...
        <div className="relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative pl-16 pb-16">
              ...
              <div>
                <h3
                  className={` ${styles["dynamic-subtitle"]} ${monsterfont2.className} text-white mb-4`}
                >
                  {step.title}
                </h3>
                <p
                  className={` ${styles["dynamic-description"]} font-helveticaneue text-semi-white mb-2`}
                >
                  {step.description}
                </p>
              </div>
