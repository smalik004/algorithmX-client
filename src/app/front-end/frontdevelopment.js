...
const ResponsiveWebDesignTitle = () => (
  <Link href="/web-development" className=" hover:text-blue-400">
    Responsive Web Design
  </Link>
);

const UXDescriptionWithLink = () => (
  <>
    AlgorithmX's UX services include creating unique digital experiences that
    involve grasping user requirements, crafting instinctive interfaces, and
    testing usability to enhance engagement and{" "}
    <Link href="/branding" className=" text-blue-300 hover:text-blue-400">
