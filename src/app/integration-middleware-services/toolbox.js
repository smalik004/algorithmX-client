...
const IntegrationTechnologyToolbox = () => {
  const tools = [
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Our integration and middleware stack leverages modern protocols,
          orchestration tools, and AI-enhanced platforms to enable secure,
          scalable, and real-time data exchange across distributed systems.
        </p>
...
export default IntegrationTechnologyToolbox;
