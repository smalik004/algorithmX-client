  ...
  const technologies = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: " Cloud ", icon: "/images/google-cloud-storage.png" },
    ...
    },
    {
      ...
      items: [
        { name: "GoogleMap", icon: "/images/google-map-icon.png" },
    ...
    },
    {
      title: "Devops",
      items: [
        { name: "Developer", icon: "/images/google-developer-tool.png" },
        { name: "AzureDevop", icon: "/images/azure-devops.png" },
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="text-center mb-12">
        <h2
          className={` ${styles["tech-title"]} ${monsterfont1.className} mb-2`}
        >
          WE LEVERAGE
        </h2>
        ...
        {technologies.map((tech, index) => (
          ...
          >
            <div className="grid grid-cols-[1fr,2fr] md:grid-cols-[150px,1fr] gap-4 items-start">
              <h3
                className={` ${styles["tech-subtitle1"]} ${monsterfont.className}`}
              >
                {tech.title}
              </h3>
