    ...
    <div className="min-h-screen bg-black pt-[100px]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          >
            AlgorithmX offers comprehensive CRM development services, developing
            personalized CRM solutions to meet your business needs, improve
            customer engagement, and drive sales. Our bespoke CRM development
            company ensures a holistic view of your customer interactions,
            transforming the way you manage your customer relationships.
          </p>
        </div>
      </div>
    </div>
