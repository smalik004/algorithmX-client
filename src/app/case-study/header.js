...
export default function CaseHeader({ data }) {
  ...
  const videoUrl = data?.brandVideoURL;
  const videoTitle = data?.brandVideoTitle || "Default Case Study Title";
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      <Head>
        <title>{`${brandName} Digital Expansion Case Study`}</title>
        <meta
          name="description"
          content={`How we helped ${brandName} expand their digital presence`}
        />
