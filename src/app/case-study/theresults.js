...
export default function Results({ data }) {
  ...
  const metrics = data?.metrices || {};

  const results = [
    {
      value: metrics.avgRatings?.toString(),
      label: "Average Rating on the Play and App Store",
      hasArrow: false,
    },
    {
      value: metrics.conversionRate || "22%",
      label: "Conversion Rate",
      hasArrow: true,
    },
    {
      value: metrics.totalOrders || "50%",
      label: "Total Orders Coming Through App",
      hasArrow: true,
    },
    {
      value: metrics.repeatPurchases || "60%",
      label: "Repeat Purchases Across Channels",
      hasArrow: true,
    },
    {
      value: metrics.orderFulfilledPerDay || "30,000+",
      label: "Orders Fulfilled Through App Per Day",
      hasArrow: false,
    },
    {
      value: metrics.sessionRevenueUplift || "100%",
