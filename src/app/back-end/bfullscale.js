...
const FrontEndTitleWithLink = () => (
  <Link href="/front-end" className=" hover:text-blue-400">
    Front-End Development
  </Link>
);

const UXUITitleWithLink = () => (
            ...
            >
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                >
                  ...
                  <p className={`${styles["scale-description"]}  `}>
                    {service.description}
                  </p>
                </div>
              </div>
