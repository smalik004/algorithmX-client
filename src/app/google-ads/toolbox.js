...
const TechnologyToolbox = () => {
  const tools = [
    ...
    },
    {
      ...
      image: "/images/Google-Optimize.png",
    },
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Google Ads’ tech stack includes ad servers, keyword planners, AI
          algorithms, bidding systems, analytics platforms, and tracking tools
          for performance.
        </p>
        <div
