...
const PPCTechnologyToolbox = () => {
  const tools = [
    { id: "ae", name: "AdEspresso", image: "/images/AdEspresso.png" },
    {
      ...
      image: "/images/Adobe-Analytics.png",
    },
    ...
    { id: "sear", name: "Google-Ads", image: "/images/Google-Ads (1).png" },
    {
      ...
      image: "/images/Google-Ads-Remarketing.png",
    },
    {
      id: "hot",
    ...
    },
    {
      ...
      image: "/images/Google-Data-Studio.png",
    },
    {
      id: "ai",
      name: "Keyword Planner",
      image: "/images/Google-Keyword-Planner.png",
    },
    ...
    },
    {
      id: "sch",
      name: "Insight Tag",
      image: "/images/LinkedIn-Insight-Tag.png",
    },
    {
      id: "cs",
      name: "Microsoft Ads",
    ...
    { id: "tweet", name: "Twitter Ads ", image: "/images/Twitter-Ads.png" },
    {
      ...
      image: "/images/Twitter-Conversion-Tracking.png",
    },
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-[1200px] mx-auto">
        <h1
          className={` text-[50px] md:text-[56px] leading-[60px] tracking-[0.06em] text-center  ${monsterfont.className} mb-3 sm:mb-4`}
        >
          TECHNOLOGY TOOLBOX
        </h1>
        ...
        <p
          className={`text-semi-white text-center text-[16px]  ${monsterfont1.className} mb-8 sm:mb-16  px-2`}
        >
          Comprehensive SEO services toolkit to enhance online visibility, drive
          organic traffic, and boost search rankings.
        </p>
        <div
