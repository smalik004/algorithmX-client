  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="A responsive 3-column layout with video player"
        />
              ...
              {!isPlaying ? (
                <div className="relative">
                  ...
                  <div className="absolute bottom-2 right-2 flex items-center space-x-2">
                    <span className="bg-black bg-opacity-75 text-white px-2 py-1 text-sm rounded">
                      03:40
                    </span>
          ...
          <div className="space-y-6">
            {middleColumnItems.map((item) => (
              <Link
                key={item.id}
                href={item.link}
                className="flex rounded-lg overflow-hidden hover:text-blue-500 transition-shadow"
              >
            ...
            <div className="space-y-6">
              {rightColumnItems.map((item) => (
                <Link
                  key={item.id}
                  href={item.link}
                  className="flex items-start  hover:hover:text-blue-500 p-2 rounded transition-colors"
                >
