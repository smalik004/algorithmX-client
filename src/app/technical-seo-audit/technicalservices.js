...
const TechnicalServices = () => {
  ...
  const tabs = [
    {
      id: "on-page",
      label: "Crawlability & Sitemaps",
      icon: faDelicious,
      content: {
        title: "Crawlability & Sitemaps",
    ...
    },
    {
      ...
      content: {
        title: (
          <Link href="/penalization-recovery" className=" hover:text-blue-400">
            Penalty Recovery
          </Link>
        ),
        text: "Our penalty recovery service helps you identify and resolve issues that may have triggered a Google penalty. We'll analyze your site, identify the cause of the penalty, and implement a recovery plan to get your site back in good standing with search engines.",
        items: [
          "Manual action analysis",
          "Algorithm penalty identification",
          ...
          >
            {tabs.map((tab) => (
              ...
              >
                ...
                />
                <span
                  className={`text-[15.2px] leading-[26px] tracking-[0.01em] ${monsterfont2.className} whitespace-nowrap`}
                >
                  {tab.label}
                </span>
              </button>
