  ...
  const steps = [
    {
      ...
      description: 'Uncover hidden insights and patterns in your data.',
      color: 'bg-green-400',
    },
    {
      number: '02',
      title: 'Map Opportunities',
      description: 'Identify areas for data-driven optimization and innovation.',
      color: 'bg-cyan-400',
    },
    {
      number: '03',
      title: 'Technology Roadmap',
      description: 'Plan the necessary tech infrastructure for your data strategy.',
      color: 'bg-red-400',
    },
    {
      number: '04',
      title: 'Project Planning',
      description: 'Execute initiatives aligned with your objectives.',
      color: 'bg-orange-400',
    },
    {
      number: '05',
      title: 'Data Implementation',
      description: 'Collect, store, and manage data per the roadmap.',
      color: 'bg-yellow-400',
    },
    {
      number: '06',
      title: 'Continuous Improvement',
      description: 'Monitor, analyze, and refine your data strategy.',
      color: 'bg-blue-400',
    },
  ];
