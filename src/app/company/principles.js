...
const GuidingPrinciples = () => {
  const principles = [
    {
      ...
      number: "01",
      description:
        "We lead with originality, forging our own path instead of following the crowd.",
    ...
    },
    {
      ...
      number: "02",
      description:
        "We design with purpose and intention, not merely to follow trends.",
    ...
    },
    {
      ...
      number: "03",
      description:
        "We aim to make every design unique, standing out in a sea of sameness.",
    ...
    },
    {
      ...
      number: "04",
      description:
        "Design isn't just about appearance, it's about seamless functionality.",
    ...
    },
    {
      ...
      number: "05",
      description:
        "Our motivation stems from our passion for design, not solely financial gain.",
    ...
    },
    {
      ...
      number: "06",
      description:
        "We invest time in comprehending our clients' needs and visions.",
  ...
  return (
    <div className="min-h-screen bg-black p-8">
      <h1
        className={`font-size-64 text-white ${monsterfont.className} text-center mb-16`}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-7 max-w-6xl mx-auto">
        {principles.map((principle, index) => {
          ...
          const isVisible = visiblePrinciples.includes(
          ...
          return (
            ...
            >
              <div className="flex flex-col h-full">
                <div
                  className={`flex items-start ${monsterfont1.className} mb-2 text-white`}
                >
                  {principle.title}
                  <p
                    className={`text-semi-white ${monsterfont1.className} text-lg ml-2 mb-2`}
                  >
                    {principle.number}
                  </p>
                </div>
                ...
                <p
                  className={`text-semi-white text-sm font-helvetica leading-relaxed`}
                >
