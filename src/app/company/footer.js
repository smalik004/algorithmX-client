        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-start">
              <h2 className="font-size-16 font-bold text-white mb-4">
                ALGORITHMX
              </h2>
          ...
          {/* Social Media Links */}
          <div className="space-y-4">
            <h3 className="font-semibold font-size-16 text-white mb-6">
              FOLLOW US
            </h3>
          ...
          <div className="space-y-4">
            <h3 className="font-size-16 font-semibold text-white mb-2">
              ALGORITHMX NEWSLETTER
            </h3>
