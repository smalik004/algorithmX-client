...
const crmServices = [
  {
    ...
    content:
      "As a leading custom software development company, we carefully evaluate your business needs, design software structures and guarantee maximum development benefits to you. Our dedicated software developers in USA use their technical knowledge and skills to deliver tailored software solutions that improve operational efficiency and increase productivity.",
  },
  {
    id: 2,
    ...
    content:
      " Achieve the expected level of business competence in the current competitive market landscape, custom software development plays a crucial role in achieving optimal business efficiency. AlgorithmX offers the best custom software development service in USA, delivering custom software solutions designed for your particular business needs.",
  },
  {
    id: 3,
    ...
    content:
      "As a notable agency in custom software development, we focus on helping companies achieve lasting success by using our bespoke enterprise software development services and solutions ranging from simple to complex ones. Our software development consulting services aim to expand your business infrastructure simultaneously improving other critical areas of your organization.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    content:
      "When a company adopts a new technology it may face obstacles with its current systems. Our specialized team of software developers utilizes advanced methods and technologies to tackle any issues related to implementation and integration of software covering optimization, testing and design.",
  },
  {
    id: 6,
    title: (
    ...
    content:
      "At our custom software development company, we offer outstanding CRM software development for streamlining your business processes, improving customer relationships, and boosting the effectiveness of your business operations.",
  },
  {
    id: 7,
    ...
    content:
      "In our offshore software development services, our team provides API development and integration solutions to enhance the connectivity of your software applications with your customers and vendor partners, increasing revenue generation.",
  },
];
...
const CRMServices = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <h2
        className={`text-[38.4px] leading-[42px] md:text-[64px] md:leading-[68px] ${monsterfont.className} mb-8 md:mb-16 text-center text-3xl`}
      >
        Discover our End-to-End <br />{" "}
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row">
          ...
          >
            {crmServices.map((service) => (
              ...
              >
                ...
                >
                  <span
                    className={`md:mr-6 transition-colors  w-[14.4px] ${
                  ...
                  <span
                    className={`${styles["left-text"]} ${monsterfont2.className}`}
                  >
                    {service.title}
                    <span
                      className={`ml-1 transition-colors mb-[4px]  w-[6.4px] ${
                        isIconGreen(service.id)
                          ? "text-green-500"
                          : "text-white"
                      }`}
                    >
        ...
        >
          <div
            className={`md:pt-6 pt-2 pr-2 pl-2 md:pr-10 md:pl-10  ${styles["box-border1"]} rounded w-full h-[450px] md:h-[300px]`}
          >
