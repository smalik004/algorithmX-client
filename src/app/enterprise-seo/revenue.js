    ...
    return (
        ...
        <div className="max-w-6xl mx-auto w-full">
            ...
            <div className="md:hidden flex flex-col h-full">
                ...
                <h3 className={`text-[34px] leading-[42px] font-helveticaneue font-[500] mb-5`}>{content[activeTab].boxTitle}</h3>
            ...
            <div className="hidden md:flex h-full p-4">
                ...
                <div key={activeTab} className={contentClasses}>
                    ...
                    <h3 className={`text-[34px] leading-[42px] font-helveticaneue font-[500] `}>{content[activeTab].boxTitle}</h3>
                    <div className={`${styles["box-title"]} text-semi-white whitespace-pre-line`}>
                        {content[activeTab].description}
                    </div>
                    </div>
