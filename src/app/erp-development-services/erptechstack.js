  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="text-center mb-12">
        <h2 className={`${style["tech-title"]} ${monsterfont1.className} mb-2`}>
          WE LEVERAGE
        </h2>

        <h2 className={` ${style["tech-subtitle"]} ${monsterfont2.className}`}>
          TECH STACK
        </h2>
        <h2 className={` ${style["tech-subtitle"]} ${monsterfont.className}`}>
          EXPERTISE
        </h2>
      </div>
        ...
        {technologies.map((tech, index) => (
          ...
          >
            <div className="grid grid-cols-[1fr,2fr] md:grid-cols-[200px,1fr] gap-4 items-start">
              <h3
                className={` ${style["tech-subtitle1"]} ${monsterfont.className}`}
              >
                {tech.title}
              </h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4 ">
                {tech.items.map((item, itemIndex) => (
                  ...
                  >
                    ...
                    />
                    <span
                      className={`${style["tech-description"]} ${monsterfont.className} text-semi-white`}
                    >
                      {item.name}
                    </span>
                  </div>
