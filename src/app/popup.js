  ...
  const testimonials = [
    {
      ...
      quote:
        "It has been a pleasure working with Appinventiv. The team is extremely versatile, competent, professional, and responsive.",
    },
    {
      name: "Sarah Johnson",
      title: "CTO",
      ...
      quote:
        "Appinventiv delivered beyond our expectations. Their technical expertise turned our vision into a seamless digital experience.",
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "Working with Appinventiv has been transformative for our business. Their strategic approach helped us launch ahead of schedule.",
    },
  ];
          ...
          <div className="bg-black bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-lg border border-white border-opacity-20 shadow-2xl w-full max-w-[600px] relative overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="bg-black bg-opacity-20 w-full md:w-2/5 p-4 relative">
              <div className="h-full flex flex-col">
                <div className="mb-3">
                  <h2 className="text-lg font-[400] text-white">
                    Leaving already?
                  </h2>
              ...
              {submitted ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-white">
                    We wil be contact you soon
                  </p>
                </div>
              ) : (
                <div className="space-y-3">
                  <div>
                    <h2 className="text-base font-[400] text-white mb-2">
                  ...
                  <div className="space-y-2">
                    <div>
                      <input
                        ...
                        className={`w-full px-3 py-2 text-sm bg-transparent border-0 border-b ${
                          errors.name ? "border-b-red-500" : "border-b-gray-500"
                        } text-white placeholder:text-[12px] focus:outline-none focus:ring-0 focus:border-b-gray-300`}
