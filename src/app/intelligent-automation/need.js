  ...
  const features = [
    {
      ...
      title: 'TSupercharged Productivity and Efficiency',
      description:
        'AI-powered intelligent automation accelerates repetitive tasks with unmatched precision, enabling your team to focus on innovation and strategic growth. By optimizing operational processes, you gain a competitive advantage in today’s fast-moving market.',
      mobileOrder: 1,
    },
    {
      imageSrc: "./images/Fast.png",
      title: 'Enhanced Decision-Making',
      description: 'With AI and intelligent automation, we analyze vast data sets to extract actionable insights, supporting informed, data-driven decisions. These insights help you quickly adapt and optimize operations in response to changing market dynamics.',
      mobileOrder: 2,
    },
    {
      imageSrc: "./images/Fully.png",
      title: 'Cost Optimization',
      description: 'Intelligent automation, powered by AI, eliminates the need for labor-intensive tasks, reducing operational costs while improving accuracy. Streamlined workflows maximize resource allocation, driving financial efficiency across your organization.',
      mobileOrder: 3,
    },
    {
    ...
    },
    {
      ...
      description: "Automating routine processes allows your team to invest more time in personalized customer interactions. As a result, response times improve, customer satisfaction increases, and stronger relationships are cultivated.",
      mobileOrder: 5,
    },
    {
      imageSrc: "./images/Built.png",
      title: 'Reduced Errors & Increased Compliance',
      description:
        'AI-driven automation ensures tasks are consistently executed with high precision, reducing human error and reinforcing compliance with industry regulations and standards. Operational integrity is maintained across all processes.',
      mobileOrder: 6,
    },
  ];
