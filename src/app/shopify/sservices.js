...
const SEODescriptionWithLink = () => (
  <>
    With our amazing{" "}
    <Link href="/ecommerce-seo" className="text-blue-300 hover:text-blue-400">
      Shopify SEO service
    </Link>
    , capture your audience's attention and stand out from competitors while
    attracting a steady flow of customers.
  </>
);

const ThemeDescriptionWithLink = () => (
  <>
    Our team of{" "}
    <Link href="/graphics" className="text-blue-300 hover:text-blue-400">
      UI/UX designers
    </Link>{" "}
    and certified Shopify developers work together to offer top-notch Shopify
    development services with a goal of creating user-friendly, dynamic, and
    responsive Shopify themes tailored for your store.
  </>
);
    ...
    <div className="min-h-screen bg-black p-4 sm:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2
            className={` text-[40px] leading-[44px] md:text-[56px] md:leading-[60px] tracking-[0.06em] ${monsterfont2.className} mb-2 text-white`}
          >
            SHOPIFY DEVELOPMENT
          </h2>
          <h2
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3
                  className={`${styles["development-title"]} font-helveticaneue  mb-[18px] text-white`}
                >
                  {service.title}
                </h3>
                <p
