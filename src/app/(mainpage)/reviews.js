...
const ReviewCard = ({ title, description, author, bgImage, category }) => {
  ...
  const { bgColor, textColor, opacity } = categoryColors[category] || {
  ...
  return (
    <div className="relative h-96 w-full overflow-hidden">
      ...
      <div className="relative h-full p-6 flex flex-col">
        ...
        <div className="mb-4">
          <span
            className={`inline-block ${bgColor} ${textColor} px-4 py-2 rounded-full text-[14px] leading-[32px] ${monsterfont.className} font-semibold`}
          >
            {category}
          </span>
        </div>
        ...
        <div className="space-y-4">
          <p
            className={`text-[16px] leading-[32px] ${monsterfont3.className} text-white mt-[37px] mb-[32px] tracking-[0.02em]`}
          >
            {description}
          </p>
          <p
            className={`text-[16px] leading-[32px] ${monsterfont.className} text-white mt-[37px] `}
          >
            {author}
          </p>
        </div>
  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="container mx-auto px-4 py-16">
        <h1
          className={`text-[56px]  leading-[60px] ${monsterfont3.className} text-white mb-[50px] text-center`}
        >
          OUR REVIEWS
        </h1>
