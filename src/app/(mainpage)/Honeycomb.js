        ...
        >
          <div className="flex flex-row max-sm:justify-between  items-center md:gap-4">
            ...
            <div className="max-sm:flex-1  text-white">
              <h1
                className={`${monsterfont1.className} text-[31px]  leading-[35px] md:text-[46.5px] md:leading-[24px] md:leading-[50px] md:mb-4`}
              >
                From Concept to Market Dominance!
              </h1>
              <h2
                className={` font-helveticaneue text-[19.5px] leading-[30px] md:text-[34.4px] md:leading-[22px] md:leading-[38px]`}
              >
            ...
            <div className="flex flex-row items-start md:gap-4">
              <Image
                ...
                alt="Placeholder"
                width={96} // Set to the largest (md:w-24)
                height={0} // Next.js will calculate based on intrinsic ratio if h-auto is used
                className="w-16 md:w-24 h-auto object-contain"
              />

              <div
                className={`${monsterfont.className} text-white text-[16px] md:text-[20px] max-sm:leading-[24px] `}
              >
                esthetic
                <br />
                gile
