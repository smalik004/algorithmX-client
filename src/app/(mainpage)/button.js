...
const firstRowIcons = [
  ...
  {
    name: "Spotify",
    colStart: "md:col-start-9",
    iconClass: "fa-brands fa-spotify",
  },
  {
    name: "GitHub",
    colStart: "md:col-start-11",
...
const secondRowIcons = [
  ...
  {
    name: "Twitter",
    colStart: "md:col-start-10",
    iconClass: "fa-brands fa-twitter",
  },
  {
    name: "Discord",
    colStart: "md:col-start-12",
          ...
          <div className="space-y-8 pb-12">
            <div className="grid md:grid-cols-2 gap-8 items-center mt-10">
              ...
              <p className="text-[16px] leading-[24px] opacity-50 font-opensans text-white">
                Achieving better performance on the platforms that matter
                involves optimizing key aspects of your digital presence. This
                includes enhancing speed, reliability, and user experience to
                ensure you meet the needs of your audience and stay competitive
                in the market.
              </p>
            </div>
            <div
              ...
              {firstRowIcons.map((item, index) => (
                ...
                >
                  <div className="w-[36px] h-[35px] flex items-center justify-center">
                    <i className={`${item.iconClass} text-[36px]`}></i>{" "}
                    {/* Icon size set to 36px */}
                  </div>
                </div>
              ))}
            </div>
