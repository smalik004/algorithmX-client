  ...
  return (
    <div className="bg-black min-h-screen overflow-hidden">
      <Head>
        ...
        <meta
          name="description"
          content="Meet our talented team of tech professionals"
        />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 md:p-12">
              ...
              >
                ...
                <p className="text-gray-300 max-w-2xl font-light">
                  A collective of forward-thinking minds, united by our passion
                  to push the boundaries of technology and redefine what's
                  possible.
                </p>
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto font-light">
            We're searching for brilliant minds to join our mission. Bring your
            unique talents and help us shape the future of technology.
          </p>
