...
const SeoFactors = () => {
  ...
  const content = {
    "scale-strategy": {
      ...
      description:
        "A visually stunning website only serves its purpose when it's visible in search results. Many clients come to us with well-designed sites that still struggle to rank due to on-page SEO issues. These issues might include , duplicate or missing title tags and meta descriptions, or duplicate URLs.\n\n AlgorithmX's SEO audit services focus on pinpointing and resolving these on-page challenges. Addressing these factors can lead to an immediate boost in rankings and visibility.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    "high-converting": {
      ...
      description:
        "Off-page factors make up about 80% of search engines' ranking algorithms, with link-building as a key element. Link quality, anchor text, and placement are essential, yet hidden from typical site visitors and difficult to evaluate without expert tools.\n\n Through off-page SEO audits, AlgorithmX helps identify and optimize these influential factors to build your online reputation and amplify authority, setting us apart as a top choice for offshore SEO auditing services.",
      icon: (
        <svg
          viewBox="0 0 32 32"
          fill="currentColor"
    ...
    <div className="p-4 md:p-8 bg-black text-white md:min-h-screen flex items-center justify-center">
      <div className="max-w-6xl mx-auto w-full">
        <div className="text-center mb-8 md:mb-12">
          ...
          <h2
            className={`leading-[40px] text-[36px] md:text-[56px] mt-[20px]  text-center  ${monsterfont.className} `}
          >
            IMPACTING YOUR SEO
          </h2>
        </div>
                  ...
                  >
                    <span
                      className={`w-6 h-6 transition-colors duration-300 ${
                        activeTab === key
                          ? "text-red-500"
                          : "text-semi-white group-hover:text-white"
                      }`}
                    >
                      {value.icon}
                    </span>
                ...
                >
                  ...
                  <span
                    className={`font-helveticaneue text-[15px] leading-[22px] ml-[8px] ${
                      activeTab === key
                        ? "text-white"
                        : "text-[#FFFFFF80] group-hover:text-[#d7d7d7] transition-colors duration-700"
                    }`}
                  >
                    {value.mainTitle}
                  </span>
