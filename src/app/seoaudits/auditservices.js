  ...
  const tabs = [
    {
      ...
      content: {
        ...
        bottomText:
          "In addition to identifying these issues, we provide specific recommendations to address each one, equipping you with the knowledge to optimize your site effectively.",
    ...
    },
    {
      ...
      content: {
        ...
        bottomText:
          "Our insights go beyond general advice, offering a targeted strategy to build high-quality links that align with your business goals.",
        useCustomContent: false,
      },
    },
    {
      ...
      content: {
        ...
        bottomText:
          "Our team provides solutions to enhance indexing and visibility, with a development team on hand to implement any required technical fixes.",
        useCustomContent: false,
      },
    },
    {
      ...
      content: {
        ...
        bottomText:
          "The SEO Audit report is designed to guide your team or to hand over to our AlgorithmX experts for seamless implementation.",
        useCustomContent: false,
      },
    },
    {
      ...
      content: {
        ...
        customContent: [
          {
            header: "In-house handling",
            description: "We'll provide support and training to your team.",
          },
          {
            header: "AlgorithmX implementation",
            description:
              "Access to our SEO specialists, developers, and content experts to manage every aspect of the implementation.",
          },
        ],
        bottomText:
          "With these options, you can start capitalizing on the audit insights to boost traffic and conversions effectively.",
    ...
    },
    {
      ...
      content: {
        ...
        bottomText:
          "This personalized strategy positions your business for long-term success, with an actionable roadmap tailored to your goals.",
        useCustomContent: false,
      },
    },
  ];
          ...
          {tabs.map((tab) => (
            ...
            >
              <div className="text-center max-w-4xl mx-auto px-4">
                ...
                <p
                  className={`text-[16px] leading-[22px] font-helveticaneue mb-[30px]`}
                >
                  {tab.content.text}
                </p>
