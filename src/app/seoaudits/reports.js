  ...
  return (
    <div className="bg-black text-white min-h-screen p-8 flex items-center justify-center  ">
      <div className="max-w-[1200px] mx-auto  mb-16">
        ...
        >
          Our detailed reports don’t just tell you what’s wrong—they give you a
          roadmap to success. Here’s <br />
          what you’ll get:
        </p>
              ...
              <div key={index} className="group p-8 relative">
                <div className="flex flex-col space-y-0">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p
                      className={`text-[24px] leading-[1.1] font-helveticaneue font-[400] text-white-500   duration-300 group-hover:-translate-x-14`}
                    >
                      {feature.subtitle}
                    </p>
                  </div>
