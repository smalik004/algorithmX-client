      ...
      <div className="max-w-[1200px] mx-auto p-4">
        ...
        <div className="text-center mb-24 relative pt-20 pb-8 w-full">
          ...
          <div className="relative z-10 mt-8">
            <h2
              className={`text-[40px] leading-[48px]  ${monsterfont.className}  mt-10`}
            >
              ANALYSIS
            </h2>
            <h2
              className={`text-[40px] leading-[48px]  ${monsterfont.className}  mb-4`}
            >
        ...
        {/* Profiling Section */}
        <div
          className={`${styles["profile-box"]} overflow-hidden max-w-7xl mx-auto`}
        >
          <div className="bg-black p-4 border-b border-teal-800">
            <h3
              className={`text-[50px] leading-[52px]  ${monsterfont2.className}  text-center`}
            >
              Profiling
            </h3>
          </div>
                ...
                <ul className="space-y-7">
                  {column.items.map((item, itemIndex) => (
                    ...
                    >
                      <FontAwesomeIcon
                        icon={faCheck}
                        className="text-white-400 mb-[20px]"
                      />
                      <span
                        className={`text-[16px] leading-[22px]  ${monsterfont2.className} text-white-500 mb-4`}
                      >
                        {item}
                      </span>
                    </li>
