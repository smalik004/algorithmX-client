...
const SEOTechnologyToolbox = () => {
  const tools = [
    ...
    { id: "deepcrawl", name: "DeepCrawl", image: "/images/DeepCrawl.png" },
    {
      id: "data",
      name: "Data Studio",
      image: "/images/Google-Data-Studio (1).png",
    },
    {
      id: "goo",
      name: "Google Business",
      image: "/images/Google-My-Business.png",
    },
    {
      id: "sear",
      name: "Search Console",
      image: "/images/Google-Search-Console.png",
    },
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div
          className={`container justify-center justify-items-center ${styles["margin1"]} ml-[12px] md:ml-0`}
        >
