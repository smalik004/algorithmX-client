...
export default function Services() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "We offer digital content services, where we generate captivating content like blogs, articles, infographics and videos.",
      mobileOrder: 2,
    },
    {
      ...
      description:
        "AlgorithmX’s content optimization services enhance the performance and visibility of content by leveraging SEO and improving user experience.",
      mobileOrder: 3,
    },
    {
    ...
    },
    {
      ...
      description:
        "Our digital content marketing services offer support and recommendations regarding development and execution of the content strategies.",
      mobileOrder: 5,
    },
    {
...
const FeatureCard = ({
  ...
  >
    ...
    <div>
      <h3
        className={`text-white text=[16px] leading-[24px] tracking-[0.1em] ${monsterfont2.className} mb-4`}
      >
        {title}
      </h3>
