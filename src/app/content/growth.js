          ...
          {services.map((service, index) => (
            <div
              ...
              className={`relative p-4 rounded-[20px] text-center transition-all duration-300 ${
                activeBox === index || (index === 1 && activeBox === null)
                  ? "bg-[#131313]"
                  : ""
              }`}
            ...
            >
              ...
              <div className="block md:hidden">
                <div className="flex flex-col items-center">
                  ...
                  <h3
                    className={`${style["growth-title"]} ${monsterfont1.className} mt-4`}
                  >
                    {service.title}
                  </h3>
                  <p
                    className={`${style["growth-description"]} text-semi-white mt-4`}
                  >
                    {service.description}
                  </p>
                </div>
              ...
              <div className="hidden md:block">
                {service.position === "right" && (
                  <div className="flex flex-col items-start">
                    <div className="flex w-full items-center">
                      <div className="w-2/3">
                        <h3
                          className={`${style["growth-title"]} ${monsterfont1.className} text-left`}
                        >
                          {service.title}
                        </h3>
                      </div>
                    ...
                    <div className="mt-4 text-right">
                      <p
                        className={`${style["growth-description"]} text-semi-white`}
                      >
                        {service.description}
                      </p>
                    </div>
                ...
                {service.position === "top-border" && (
                  <div className="flex flex-col items-center text-center relative">
                    ...
                    <h3
                      className={`${style["growth-title"]} ${monsterfont1.className} mt-12`}
                    >
                      {service.title}
                    </h3>
                    <p
                ...
                {service.position === "left" && (
                  <div className="flex flex-col items-end">
                    ...
                    <div className="mt-4 text-left">
                      <p
                        className={`${style["growth-description"]} font-opensans font-[500] text-semi-white`}
                      >
                        {service.description}
                      </p>
                    </div>
