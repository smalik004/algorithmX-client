...
const TechnologyToolbox = () => {
  const tools = [
    ...
    },
    {
      ...
      image: "/images/YouTube-Analytics.png",
    },
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          YouTube Ads' tech stack combines intelligent video targeting, machine
          learning optimization, audience insights, performance metrics, and
          dynamic bidding technology.
        </p>
        <div
