  ...
  const content = {
    "scale-strategy": {
      ...
      description: (
        <>
          <p>
            For local SEO, you require more than just an SEO specialist — you
            need an entire team. That's precisely why our local SEO plans offer
            you a comprehensive digital marketing team, equipped with the
            diverse skill sets necessary to develop, implement, manage, and
            scale your SEO strategy.
          </p>
          <div className="grid md:grid-cols-2 gap-8 mt-6">
            <div className="space-y-4">
              <p className="font-helveticaneue text-[15px] leading-[22px]">
                Your dedicated account manager will oversee an in-house team
                comprising:
              </p>
              <ul
                className="pl-6 font-helveticaneue text-[15px] leading-[22px] text-[#FFFFFFB3]"
            ...
            <div className="space-y-4">
              <p className="font-helveticaneue text-[15px] leading-[22px]">
                When equipped with all the resources for local SEO, it becomes
                effortless to:
              </p>
              <ul
                className="pl-6 font-helveticaneue text-[15px] leading-[22px] text-[#FFFFFFB3]"
    ...
    "sync-strategy": {
      ...
      description: (
        <>
          <p className="mt-4">
            Like many businesses, yours likely invests in various digital
            marketing strategies such as local SEO, content marketing, and
            digital advertising to drive revenue. When partnering with an agency
            like AlgorithmX that can align your local SEO strategy with your
            overall approach, you optimize your ROI. As your partner, we'll
            synchronize your local SEO plan with your overarching campaigns by
            offering:
          </p>
          <ul
            className="pl-6 text-gray-400 leading-relaxed mt-4"
            style={{ listStyleType: "none" }}
          >
            <li
              style={{
            ...
            >
              ...
              ></span>{" "}
              A dedicated team of specialized experts in digital marketing,
              business, and beyond.
            </li>
            <li
              style={{
            ...
            >
              ...
              ></span>{" "}
              Full-funnel reporting to measure the bottom-line impact of all
              your strategies.
            </li>
            <li
              style={{
    ...
    <div className="p-4 md:p-8 bg-black text-white min-h-screen flex items-center justify-center">
      <div className="max-w-6xl mx-auto w-full">
        <div className="text-center mb-8 md:mb-12">
          <div
            className={`text-[#2775ff] leading-[18px] font-[18px] ${monsterfont2.className} text-center`}
          >
            HOW WE
          </div>
          <h1
          ...
          <div className="md:hidden flex flex-col h-full">
              ...
              <div className="flex space-x-6 min-w-min">
                {Object.entries(content).map(([key, value]) => (
                  ...
                  >
                    ...
                    <span className="font-helveticaneue text-[15px] leading-[22px] ">
                      {value.mainTitle}
                    </span>
                  </button>
                ))}
            ...
            <div className="flex-1 overflow-hidden p-4">
              <div key={activeTab} className={contentClasses}>
                <h3
                  className={`text-[34px] leading-[42px] ${monsterfont.className} mb-5`}
                >
                  {content[activeTab].boxTitle}
                </h3>
                <div
                  className={`${styles["box-title"]} text-semi-white whitespace-pre-line`}
                >
          ...
          <div className="hidden md:flex h-full p-6">
            ...
            <div className="flex-1 pl-6 overflow-hidden">
              <div className="h-full overflow-hidden pr-4">
                <div key={activeTab} className={contentClasses}>
                  <h3
                    className={`text-[34px] leading-[42px] ${monsterfont.className}`}
                  >
                    {content[activeTab].boxTitle}
                  </h3>
                  <div
