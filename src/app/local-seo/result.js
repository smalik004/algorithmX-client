...
const content = {
    ...
    description: (
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-6">
            ...
            <p className="font-helveticaneue text-[15px] leading-[22px]">Your dedicated account manager will oversee an in-house team comprising:</p>
            <ul className="pl-6 font-helveticaneue text-[15px] leading-[22px] text-[#FFFFFFB3]" style={{ listStyleType: 'none' }}>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Local SEO experts</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Content specialists</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Copywriters</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Web developers</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Web designers</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Business consultants</li>
            </ul>
            </div>
            <div className="space-y-4">
            <p className="font-helveticaneue text-[15px] leading-[22px]">When equipped with all the resources for local SEO, it becomes effortless to:</p>
            <ul className="pl-6 font-helveticaneue text-[15px] leading-[22px] text-[#FFFFFFB3]" style={{ listStyleType: 'none' }}>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Publish localized content</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Manage local listings</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Improve on-page SEO</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Refine strategy</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>Pass competitors</li>
                <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#FFFFFFB3', borderRadius: '50%' }}></span>And more</li>
            </ul>
            </div>
        </div>
        </>
    ...
    description: (
        ...
        <ul className="pl-6 text-gray-400 leading-relaxed mt-4" style={{ listStyleType: 'none' }}>
            <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#9CA3AF', borderRadius: '50%' }}></span> A dedicated team of specialized experts in digital marketing, business, and beyond.</li>
            <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#9CA3AF', borderRadius: '50%' }}></span> Full-funnel reporting to measure the bottom-line impact of all your strategies.</li>
            <li style={{ position: 'relative', paddingLeft: '20px', marginBottom: '8px' }}><span style={{ position: 'absolute', left: 0, top: '8px', width: '10px', height: '10px', backgroundColor: '#9CA3AF', borderRadius: '50%' }}></span> And more.</li>
        </ul>
        </>
    ),
    icon: (
...
return (
    ...
    <div className="max-w-6xl mx-auto w-full">
        ...
        <div className={`text-[#2775ff] leading-[18px] font-[18px] ${monsterfont2.className} text-center`}>HOW WE</div>
