    ...
    <div className="min-h-screen bg-black text-semi-white p-4 md:p-8 flex items-center justify-center">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-16">
          <h2
            className={`text-[50px] leading-[55px] md:text-[64px] md:leading-[68px] text-white ${monsterfont.className} `}
          >
            Deliverables
          </h2>
          <h2
            className={`text-[50px]  leading-[55px] md:text-[64px] md:leading-[68px] text-white ${monsterfont1.className} `}
          >
            To Clients
          </h2>
        </div>
        ...
        <div className="bg-[#030c0d] rounded-xl md:rounded-3xl p-6 md:p-12 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 relative">
            ...
            <div className="col-span-1 md:col-span-8 space-y-8 md:space-y-12">
              ...
              <div>
                <h3
                  className={`text-[25px] leading-[1.1] font-helveticaneue text-semi-white mt-[20px] mb-[10px] `}
                >
                  On-Page Local SEO
                </h3>
                <ul className="space-y-3 md:space-y-4 ml-[30px]">
                  ...
                  <li className="flex items-start gap-2 gap-2">
                    <FontAwesomeIcon
                      icon={faCheck}
                      className="text-gray-400 mb-[10px] font-bold"
                    />
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span
                      className={`text-[16px] leading-[22px] font-helveticaneue text-semi-white  `}
                    >
                      Quarterly SEO copy or GMB posts with locally-optimized
                      terms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span
                      className={`text-[16px] leading-[22px] font-helveticaneue text-semi-white  `}
                    >
                      Card microformat/schema HTML tags addition to address on
                      website
                    </span>
                  </li>
                </ul>
                ...
                <ul className="space-y-3 md:space-y-4 ml-[30px]">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span
                      className={`text-[16px] leading-[22px] font-helveticaneue text-semi-white  `}
                    >
                      Citation management on Apple Maps
                    </span>
                  </li>
                </ul>
              </div>
