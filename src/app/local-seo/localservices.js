  ...
  const tabs = [
    {
      ...
      content: {
        title: (
          <Link href="/seoaudits" className=" hover:text-blue-400">
            Local SEO Audit
          </Link>
        ),
        ...
        conclusion:
          "Armed with these insights, we craft a strategic plan tailored to your business, zeroing in on the areas with the biggest potential for impact.",
      },
    },
    {
      id: "off-page",
    ...
    },
    {
      ...
      content: {
        ...
        conclusion:
          "Plus, with access to representatives from Google, Bing, and Facebook, any issues are resolved quickly and efficiently, keeping your listings competitive.",
      },
    },
    {
      id: "report",
    ...
    },
    {
      ...
      content: {
        ...
        conclusion:
          "With local SEO outsourcing, everything from SEO to copywriting and development is taken care of; you can focus on running your business while we focus on driving results.",
      },
    },
  ];
