...
const DAppDevelopmentPage = () => {
  ...
  const sections = {
    robustSecurity: {
      ...
      description:
        "Our team leverages deep expertise in blockchain to develop secure, transparent, and decentralized applications that ensure data integrity and trust across all operations.",
      image: "/images/a1.png",
    },
    reliableConnectivity: {
      ...
      description:
        "Our skilled development team brings your ideas to life with precision, delivering high-performance solutions using modern tech stacks and agile methodologies.",
    ...
    prioritizingUsability: {
      ...
      description:
        "We offer a flexible project-based engagement model tailored to your goals, ensuring timely delivery, clear milestones, and efficient resource utilization.",
      image: "/images/a1.png",
    },
    scalability: {
      ...
      description:
        "We craft intuitive UI/UX designs that prioritize user engagement, making complex processes simple, seamless, and visually appealing for every user.",
      image: "/images/Why.webp",
    },
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white flex justify-center">
      <div className="w-full max-w-[1200px] px-4 py-12">
        ...
        >
          As a trusted DApp development company, we have established ourselves
          as a leading provider by delivering decentralized, user-centric
          applications for top brands. Being a premium DApp software development
          company, we focus on bridging the gap between innovation and
          usability, offering secure and scalable blockchain solutions.
        </p>
