...
const carouselData = [
  ...
  },
  {
    ...
    description3:
      " and lean more towards building your in-house team, our premier ERP development company provides outstanding ERP staff augmentation services that allow you to hire talented and experienced professionals who are critical to the success of your project.",
  },
];
...
const Carousel = () => {
  ...
  return (
    <div className="w-full mx-auto px-4 py-8 bg-black relative">
      <h2
        className={`${styles["erp-text"]} ${monsterfont.className} text-white mb-12`}
      >
        Custom ERP Services
      </h2>
      <div
            ...
            >
              ...
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <p
                    className={`${styles["service-description"]} text-semi-white`}
                  >
                    {item.description}
                    {item.description2}
                    {item.description3}
