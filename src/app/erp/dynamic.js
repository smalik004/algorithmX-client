    ...
    <div className=" bg-black p-8 flex items-center justify-center">
      <div className="relative w-full max-w-4xl mx-auto mt-20">
        ...
        <div className="px-4 py-16">
          <h2
            className={`${style["dynamic-text"]} text-white ${monsterfont.className}`}
          >
            DYNAMIC SOLUTIONS
          </h2>
          ...
          <p
            className={`max-w-3xl ${style["dyanmic-description"]} text-semi-white`}
          >
            Drive progress seamlessly. Transform your processes with agile ERP
            solutions that elevate performance, enhance collaboration, and scale
            with your vision.
          </p>
        </div>
