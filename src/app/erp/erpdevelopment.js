  ...
  const steps = [
    {
      title: "Discovery",
      description:
        "Analysis of business requirements and engineering of ERP needs.",
      color: "bg-[#fff200]",
    ...
    },
    {
      ...
      description:
        "Crafting secure, scalable architecture and role-specific UX/UI for ERP software.",
      color: "bg-[#ff793f]",
    ...
    },
    {
      ...
      description:
        "Defining project scope, success metrics, team, timelines, budget, risks, and mitigation.",
      color: "bg-[#EA2027]",
    ...
    },
    {
      ...
      description:
        "Creating new solutions, modernizing existing ERP, or customizing market-available ERPs.",
      color: "bg-[#32ff7e]",
    ...
    },
    {
      title: "Integration",
      description:
        "Establishing connections among ERP modules and integrating ERP with systems.",
      color: "bg-[#b71540]",
    ...
    },
    {
      ...
      description:
        "Migrating enterprise data to ERP from spreadsheets or previous systems.",
      color: "bg-[#00a8ff]",
    ...
    },
    {
      title: "Deployment",
      description:
        "Configuring ERP infrastructure, deploying solutions, and transferring knowledge to users.",
      color: "bg-[#273c75]",
    ...
    },
    {
      title: "User training",
      description:
        "Creating user manuals and maintenance guides; providing in-person or remote training.",
      color: "bg-[#be2edd]",
        ...
        <div className="text-center mb-12 relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <h2>
              <span
                ref={journeyRef}
                className={`text-7xl md:text-9xl text-gray-800 font-extrabold ${
          ...
          <div className="relative z-10">
            <h2
              className={` ${styles["description"]} ${monsterfont1.className} mt-6 md:mt-20 text-white`}
            >
        ...
        <div>
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Title */}
              <div
                className={`w-48 ${step.textColor} ${style["dev-title"]} font-medium md:pl-6`}
              >
                <h3>{step.title}</h3>
              </div>
              {/* Description */}
              <div className={`${style["dev-description"]}`}>
