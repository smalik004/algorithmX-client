      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          {estimates.slice(0, 2).map((item, index) => (
            ...
            >
              ...
              <div
                className={`text-[20px]  ${monsterfont2.className} text-center`}
              >
                {item.title}
              </div>
              <div
              ...
              <p
                className={`${style["cost-description"]} font-helveticaneue mt-4 text-white`}
              >
                {item.description}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          >
            ...
            <div
              className={`${styles["cost-price"]} ${monsterfont2.className} text-center text-white`}
            >
              {estimates[2].price}
            </div>
            <p
