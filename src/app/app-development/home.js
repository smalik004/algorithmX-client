    ...
    <div className="min-h-screen bg-black pt-[100px]">
      <div className="max-w-[1200px] mx-auto px-4 md:px-2 py-10">
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          >
            AlgorithmX leverages the latest technologies to develop personalized
            Android, iOS, and cross-platform mobile applications. Our custom
            mobile app development services involve designing, developing,
            testing, and maintaining high-quality apps that offer exceptional
            user experiences.
          </p>
        </div>
      </div>
