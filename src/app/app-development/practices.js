...
const ContentItem = ({ title, description, isRightAligned }) => {
  return (
    <div className={` ${isRightAligned ? "text-right" : "text-left"} mb-10`}>
      ...
      >
        <h2
          className={`text-[24px] leading-[24px] ${monsterfont.className} text-white my-[40px] mx-[30px] `}
        >
          {title}
        </h2>
...
const AccordionItem = ({ title, content, isActive, onClick, isInView }) => {
  return (
    <div className="relative">
      ...
      >
        <span
          className={`text-[21px] leading-[22px] ${monsterfont2.className} `}
        >
          {title}
        </span>
        {isActive ? (
      ...
      <div className="max-w-[1200px] mx-auto p-4">
        <div className="text-center mb-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2
              className={` ${styles["description"]} ${monsterfont3.className} text-white`}
            >
