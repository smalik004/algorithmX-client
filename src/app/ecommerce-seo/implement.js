  ...
  const content = {
    "scale-strategy": {
      ...
      description: (
        <>
          <p>
            Your potential customers are ready to invest, but without the right
            visibility, they may never find your store. Our eCommerce SEO
            services ensure your store stands out, driving traffic and
            maximizing profits. As an eCommerce SEO agency, we specialize in
    ...
    "sync-strategy": {
      ...
      description: (
        <>
          <p className="mt-4">
            Our eCommerce SEO services improve your online presence, elevating
            your website from page two to a top position on page one of search
            results. This increased visibility boosts discoverability, helping
            potential customers find your store. For businesses seeking
            affordable, high-quality support, our affordable eCommerce SEO
            services ensure a competitive advantage without sacrificing quality.
          </p>
        </>
      ),
      icon: (
...
v-14.91H29.26V28.694z M30.638,13.949H17.687V8.515h11.397c0.858,0,1.554,0.698,1.554,1.555V13.949z"
    ...
    "cost-effective": {
      ...
      description: (
        <>
          <p className="mt-4">
            Compared to traditional methods, eCommerce SEO services provide
            exceptional cost-effectiveness. By targeting keywords your audience
            is searching for, we fine-tune your site for efficient, impactful
            results. Whether you’re looking for an eCommerce SEO consultant or
            the best eCommerce SEO agency to handle all aspects of your
            optimization, our approach maximizes your return on investment.
          </p>
        </>
      ),
      icon: (
...
v-14.91H29.26V28.694z M30.638,13.949H17.687V8.515h11.397c0.858,0,1.554,0.698,1.554,1.555V13.949z"
    ...
    "long-term": {
      ...
      description: (
        <>
          <p className="mt-4">
            With an average close rate nearing 15%, SEO outperforms traditional
            marketing, which averages just 1.7%. This dependable revenue stream
            is why many choose the best eCommerce SEO company to sustain
            long-term growth. Although results build over time, the outcome is
            consistent new business and steady growth, making enterprise
            eCommerce SEO a smart choice for forward-looking brands.
          </p>
        </>
      ),
      icon: (
    ...
    <div className="p-4 md:p-8 bg-black text-white md:min-h-screen flex items-center justify-center">
      <div className="max-w-6xl mx-auto w-full">
        <div className="text-center mb-8 md:mb-12">
          <div className="text-blue-400 font-['Helvetica'] leading-[18px] text-[18px] text-center">
            HOW WE
          </div>
          <h2
            className={`leading-[40px] text-[36px] md:text-[56px] mt-[20px] text-center ${monsterfont1.className}`}
          >
            DRIVE REVENUE
          </h2>
        </div>
        ...
        <div className="border border-red-500 w-full h-auto md:h-[500px] max-w-[900px] mx-auto">
          ...
          <div className="md:hidden flex flex-col h-full">
                  ...
                  >
                    <span
                      className={`w-6 h-6 transition-colors duration-300 ${
                        activeTab === key ? "text-red-500" : "text-semi-white"
                      }`}
                    >
                      {value.icon}
                    </span>
                    <span
                      className={`font-helveticaneue text-[15px] leading-[22px]  ${
                        activeTab === key
                          ? "text-white"
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div key={activeTab} className={contentClasses}>
                <h3
                  className={`text-[34px] leading-[42px] font-helveticaneue font-[300]`}
                >
                  {content[activeTab].boxTitle}
                </h3>
                <div
                  className={`${styles["box-title"]} font-helveticaneue text-semi-white whitespace-pre-line`}
                >
          ...
          <div className="hidden md:flex h-full p-4">
            ...
            <div className="flex flex-col space-y-8 pr-14 justify-center">
              {Object.entries(content).map(([key, value]) => (
                ...
                >
                  ...
                  <span
                    className={`font-helveticaneue text-[15px] leading-[22px] ml-[8px] ${
                      activeTab === key
                        ? "text-white"
                        : "text-[#FFFFFF80] group-hover:text-white"
                    }`}
                  >
                    {value.mainTitle}
                  </span>
            ...
            <div
              className={`relative  ${style["revline"]} flex items-center justify-center`}
            >
              <div
              ...
              <div className="h-full overflow-y-auto pr-4">
                <div key={activeTab} className={contentClasses}>
                  <div className="transition-all duration-500 transform">
                    <h3
                      className={`text-[34px] leading-[42px] font-helveticanue `}
                    >
                      {content[activeTab].boxTitle}
                    </h3>
                    <div
