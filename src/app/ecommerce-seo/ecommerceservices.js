  ...
  const tabs = [
    {
      ...
      img: "/images/keyword identitification.png",
      content: {
    ...
    },
    {
      ...
      img: "/images/keyword implementation.png",
      content: {
        ...
        conclusion:
          "Our team works to boost your local search visibility and drive meaningful growth aligned with your goals. We also optimize local SEO for service-area businesses (SAB) to boost your business in a very specific geographic radius, no matter where you're in the world.",
      },
    },
    {
      id: "technical",
      label: "Product page optimization",
      img: "/images/product page optimization.png",
      content: {
        title: "Product page optimization",
        text: "Product pages are your store's goldmine. Our eCommerce SEO consultants will optimize them with:",
        items: [
          "Keyword-rich descriptions",
          "Model numbers for search specify",
          "Clear, enticing copy to improve conversions",
        ],
        conclusion:
          'This ensures your product pages rank high when customers search for long-tail keywords like "best eCommerce platform for SEO" or "eCommerce SEO firm in USA."',
      },
    },
    {
      id: "report",
      label: "Navigation optimization",
      img: "/images/navigation optimization.png",
      content: {
        ...
        conclusion:
          "We improve the browsing experience, reduce bounce rates, and strengthen your SEO by optimizing navigation.",
      },
    },
    {
      id: "implementation",
      label: "Content creation",
      img: "/images/content creation.png",
      content: {
        title: (
          <Link href="/contentcreation" className=" hover:text-blue-400">
            Content creation
          </Link>
        ),
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <h2
          className={`text-[64px] leading-[68px] ${monsterfont.className} text-white mb-[15px] text-center`}
        >
          {" "}
          Services
        </h2>
        <div className="text-center mb-12">
          <h2
            className={`text-[21px] leading-[26px] ${monsterfont.className} text-semi-white mt-[30px] text-center`}
          >
            HOW SEO IS
          </h2>
          <h2
            className={`text-[21px] leading-[26px] ${monsterfont1.className} text-semi-white text-center`}
          >
        ...
        <div className="w-full overflow-x-auto pb-4 p-[6px] mb-8">
          <div
            className={`flex md:grid md:grid-cols-5 min-w-max md:min-w-0 max-w-[72rem] mx-auto bg-black ${styles["box-design"]} `}
          ...
          >
            {tabs.map((tab) => (
              ...
              >
                ...
                />
                <span
                  className={`text-[15.2px] leading-[26px] tracking-[0.01em] ${monsterfont2.className} text-center`}
                >
                  {tab.label}
                </span>
              </button>
          ...
          {tabs.map((tab) => (
            ...
            >
              <div className="text-center max-w-4xl mx-auto px-4">
                <h2
                  className={`text-[28px] leading-[32px] ${monsterfont.className} mb-[30px]`}
                >
                  {tab.content.title}
                </h2>
                <p
                  className={`text-[16px] leading-[22px] font-helveticaneue mb-[2px] max-w-2xl mx-auto`}
                >
                  {tab.content.text}
                </p>
                  ...
                  {tab.content.points && (
                    <div className="space-y-1 text-left">
                      {tab.content.points.map((point, index) => (
                        <p
                          key={index}
                          className={`text-[15px] leading-[22px] font-helveticaneue ml-5 `}
                        >{`${index + 1}) ${point}`}</p>
                      ))}
                    </div>
                  )}
                  ...
                  {tab.content.description && (
                    <div className="space-y-1 text-center">
                      {tab.content.description.map((desc, index) => (
                        <p
                          key={index}
                          className={`text-[16px] leading-[26px] font-helveticaneue mb-[2px] ml-5 `}
                        >
                          {desc}
                        </p>
                      ))}
