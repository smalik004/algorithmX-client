    ...
    <div className="min-h-screen bg-black p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          <h2
            className={`text-[40px] md:text-[64px] leading-[68px] ${monsterfont.className} text-white`}
          >
            Deliverables
          </h2>
          <h2
            className={`text-[40px] md:text-[64px] ${monsterfont1.className} text-white`}
          >
            To Clients
          </h2>
        </div>
            ...
            <ul className="space-y-3 md:space-y-4">
              {[
                ...
                <li key={index} className="flex items-start">
                  <FontAwesomeIcon
                    icon={faCheck}
                    className="w-5 h-5 text-semi-white mt-1 mr-2 flex-shrink-0"
                  />
                  <span className="text-[16px] leading-[22px] font-helveticaneue text-semi-white">
                    {item}
                  </span>
                </li>
              ))}
