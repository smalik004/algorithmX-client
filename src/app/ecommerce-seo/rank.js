        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-2">
            ...
            >
              ...
              looking for affordable eCommerce SEO services, we’ve got the right
              strategy for you.
            </p>
            ...
            <div className="">
              ...
              >
                ...
                ensuring that no matter what your customers are searching for,
                they find you first.
              </p>
              <p
                className={`text-[16px] leading-[22px] font-helveticaneue text-semi-white`}
              >
                From eCommerce SEO consultants to affordable eCommerce SEO
                services, we know how to rank your products across multiple
                search engines.
              </p>
            </div>
          </div>
