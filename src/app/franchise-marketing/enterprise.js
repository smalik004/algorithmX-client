  ...
  const services = [
    {
      ...
      description:
        "As a premier franchise digital marketing agency, AlgorithmX works in different niches with both individual and corporate franchise owners. Irrespective of your business’s size or type, we create adaptable, innovative franchise SEO strategies that are tailored to your marketing requirements and preferences.",
    ...
    },
    {
      ...
      description:
        "Our dedicated franchise marketing consultants collaborate with company stakeholders on project management tools and shared drives, creating an ideal environment for agency-client collaboration.",
    ...
    },
    {
      ...
      title: "Transparency",
      description:
        "Our franchise marketing agency keeps you in constant loop by sharing regular updates on how your campaigns are performing online. We ensure to keep you notified and well aware of all the modifications and their impact on your business prior to making any new adjustments to our SEO strategies.",
    ...
    },
    {
      ...
      description:
        "At our franchise digital marketing agency, we meticulously analyze our campaigns to achieve real results in less time. Following the agreed terms, our SEO experts offer updates on a weekly or bi-weekly basis, sharing reports that cover your search rankings, page visits, organic and paid traffic, and the overall performance of your website.",
    ...
    },
    {
      ...
      description:
        "As part of digital franchise marketing, we establish meticulous corporate regulations and branding guidelines that cover your website content, graphics, and brand logo, highlighting your brand image, ensuring uniformity across all digital channels, and promoting customer trust and brand visibility. reminding that leads to customer trust.",
      borderColor: "border-blue-500",
    ...
    <div className="min-h-screen bg-black p-4 sm:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2
            className={`text-[40px]  text-white ${monsterfont2.className} mb-2`}
          >
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3
                  className={`${styles["development-title"]} text-white font-helveticaneue  mb-3`}
                >
                  {service.title}
                </h3>
                <p
