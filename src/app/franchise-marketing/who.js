      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-[15px] leading-[24px] mb-[6px] font-[400] font-helveticaneue text-semi-white">
            Looking to improve your ranking on search engines, boost your
            presence, and outshine your competition? Join forces with AlgorithmX
            to get solutions for all your needs. Our franchise marketing agency
            offers outstanding franchise SEO marketing services which include:
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="text-[15px] leading-[24px] font-[400] font-helveticaneue text-semi-white flex items-start  ">
              ...
              <span className="text-semi-white">
                Tailor-made SEO strategies that cater to the specific
            ...
            <div className="text-[15px] leading-[24px] font-[400] font-helveticaneue text-semi-white flex items-start">
              <i className="fas fa-check text-semi-white text-lg font-bold mt-1"></i>
              <span className="text-semi-white">
                Numerous franchise SEO packages offer a balance of adaptability
                and value.
              </span>
            </div>
            <div className="text-[15px] leading-[24px] mt-2 font-[400] font-helveticaneue text-semi-white flex items-start  ">
              <i className="fas fa-check text-semi-white text-lg font-bold mt-1"></i>
              <span className="text-semi-white">
                Specialization in local SEO emphasizing on communities you
                serve.
              </span>
            </div>
            <div className="text-[15px] leading-[24px] mt-2 font-[400] font-helveticaneue text-semi-white flex items-start  ">
              <i className="fas fa-check text-semi-white text-lg font-bold mt-1"></i>
              <span className="text-semi-white">
                State-of-the-art multi-location marketing strategies to
                synchronize your franchisee’s efforts across all branches.
              </span>
            </div>
          </div>
        </div>
